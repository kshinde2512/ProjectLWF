...
<center>
<h1 style="font-family: cursive; color: red; font-weight: bold">
SPELLBEE</h1></center>
<center>
...
<input type=text name="L" value="L" class="A" >
<br>
<br>
...
<input type=text name="letter2" class="A" value="">
<input type=text name="G1" class="A" value="S" readonly>
<br>
<br>
...
<br>
<center>
<input type=text name="G" class="A" value="" >
<input type=text name="O" value="" class="A" >
...
<br>
<center>
<input type=text name="M" class="A" value="">
<input type=text name="A4" value="A" class="A" readonly>
<input type=text name="N3" class="A" value="" >
<input type=text name="G3" value="G" class="A" >
...
<center>
<input type=text name="letter1" class="A" value="" >
<input type=text name="letter2" value="" class="A" readonly >
<input type=text name="E" class="A" value="E" readonly>
<input type=text name="E" class="A" value="" >
<br>
<br>
...
else if(request.getParameter("Submit5")!=null && id==0)
{
	id=5;
	System.out.print(id);
		
	}
else if(request.getParameter("Submit6")!=null)
{
	id=6;
		
	}
else if(request.getParameter("Submit7")!=null)
{
	id=7;
		
	}
else if(request.getParameter("Submit8")!=null)
{
	id=8;
		
	}
else if(request.getParameter("Submit9")!=null)
{
	id=9;
...
System.out.println("select * from spellbee where id = "+id);
