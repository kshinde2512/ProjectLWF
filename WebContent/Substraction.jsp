...
<body background="background/hd1.jpg">
	<table cellspacing="20" align="center">
		...
		<h1 style="color:#DB7093;text-align:center;font-family: cursive;">Subtraction of Numbers</h1>
			...
			<form method="post">
					<td><img src="images\8.jpg" style="height: 100px; width: 100px" /></td> 
		...
		<form method="post">
				...
				<td></td><td></td><td></td><td></td><td>
				<form method="post">
					<td><img src="images\nine.jpg" style="height: 100px; width: 100px" /></td> 
					<td><img src="images\-.png" style="height: 100px; width: 100px" /></td> 
					<td><img src="images\8.jpg" style="height: 100px; width: 100px" /></td> 
					<td><span style="font : 30px cursive;color:yellow">=</span></td>
					<td><input type="text" name="n" style="height:60px;width:50px;border-radius:5px;color:Blue;font:30px cursive;text-align:center" maxlength=1/></td> 
		...
		<form method="post">
			...
			<!-- <td><form method="post">
					<img src="images\8.png" style="height: 100px; width: 100px" /> <img
						src="images\-.png" style="height: 100px; width: 100px" /> <img
						src="images\four.jpg" style="height: 100px; width: 100px" />= <input
						type="text" name="n" /> <input type="submit" name="s1">
				</form></td>
		...
		<tr>
			...
			<td><form method="post">
					<img src="images\nine.png" style="height: 100px; width: 100px" />
					<img src="images\-.png" style="height: 100px; width: 100px" /> <img
						src="images\8.png" style="height: 100px; width: 100px" />= <input
		...
		<tr>
			...
			<td><form method="post">
					<img src="images\four.jpg" style="height: 100px; width: 100px" />
					<img src="images\-.png" style="height: 100px; width: 100px" /> <img
						src="images\two.png" style="height: 100px; width: 100px" />= <input
